...
const SignUpPage = () => {
  ...
  async function submitData(e){
    ...
    try{
      let res = await axios.post('http://localhost:3000/auth/signup',val,{withCredentials:true});
      console.log(res);
      if(res.data.success){
        setError(false);
  ...
  return (
    ...
    <div className="container d-flex justify-content-center align-items-center min-vh-100"> 
      <div className="card shadow-lg border-0 signup-card w-100" style={{ maxWidth: '450px' }}>
        <div className="card-header border-0 text-center py-3 bg-yellow" id='head'>
