import '../css/login.css';import React from 'react';
    ...
    <div className="container d-flex justify-content-center align-items-center min-vh-100">
      <div className="card shadow-lg border-0 login-card w-100" style={{ maxWidth: '450px' }}>
        <div className="card-header border-0 text-center py-4 bg-yellow">
          ...
          <h5 className="mb-0 fw-bold">Employee & Admin Login</h5>
        </div>
        <div className="card-body p-4 p-md-5">
          <h3 className="text-center mb-4 fw-bold">Login Login</h3>
          <form>
            <div className="mb-3">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
              <div className="form-check">
                <input type="checkbox" className="form-check-input" id="remMe" />
                <label className="form-check-label small" htmlFor="remMe">Remember Me</label>
              </div>
              <a href="#" className="text-decoration-none small fw-bold text-dark">Forgot Password?</a>
            </div>
            <button type="submit" className="btn btn-yellow w-100 py-2 fw-bold shadow-sm">Login</button>
          </form>
          <p className="text-center mt-4 small">
            Don't have an account? <span className="text-primary fw-bold cursor-pointer" onClick={toggleForm}>Sign Up</span>
          </p>
        </div>
